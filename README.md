![Work::Md](https://raw.githubusercontent.com/work-md/work-md/master/work-md.png)
...
Run the following commands:
    ...
    $ curl -L -o work-md-0.4.91.tar.gz https://github.com/work-md/work-md/raw/master/work-md-0.4.91-linux-x86_64.tar.gz |
    $ tar -xzf work-md-0.4.91.tar.gz
    $ cd work-md-0.4.91-linux-x86_64
    $ ./work-md
